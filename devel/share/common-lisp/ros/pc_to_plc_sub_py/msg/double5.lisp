...
(cl:in-package pc_to_plc_sub_py-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <double5>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'double5)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pc_to_plc_sub_py-msg:<double5> is deprecated: use pc_to_plc_sub_py-msg:double5 instead.")))

(cl:ensure-generic-function 'alpha-val :lambda-list '(m))
(cl:defmethod alpha-val ((m <double5>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pc_to_plc_sub_py-msg:alpha-val is deprecated.  Use pc_to_plc_sub_py-msg:alpha instead.")
  (alpha m))
