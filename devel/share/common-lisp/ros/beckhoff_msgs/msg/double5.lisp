...
(cl:defmethod cl:initialize-instance :after ((m <double5>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'double5)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beckhoff_msgs-msg:<double5> is deprecated: use beckhoff_msgs-msg:double5 instead.")))

(cl:ensure-generic-function 'alpha-val :lambda-list '(m))
(cl:defmethod alpha-val ((m <double5>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beckhoff_msgs-msg:alpha-val is deprecated.  Use beckhoff_msgs-msg:alpha instead.")
  (alpha m))
